...
export default function Landing() {
  ...
  if (loading)
    return <PageLoadingSpinner text="Establishing Secure Connection..." />;
  ...
  return (
    <div
      ...
      style={{
        ...
        textAlign: "center",
        background:
          "radial-gradient(circle at center, rgba(0,212,170,0.05) 0%, var(--color-void) 70%)",
        minHeight: "100vh",
        display: "flex",
    ...
    >
      <div
        className="slide-up max-w-[600px] w-full"
      ...
      >
        ...
        >
          Real-time Sports Media Rights Intelligence.
          <br />
          ...
          >
            ...
            >
              {isRegistering
                ...
                : "Need access? Register as an operator."}
            </button>
          </form>
